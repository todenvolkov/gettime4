...
abstract class IPN_Handler
{
        ...
        const paypal_sandbox_url = 'https://developer.paypal.com/us/cgi-bin/devscr';
        ...
        {
                 file_put_contents('ipn.txt', json_encode($ipn_post_data), FILE_APPEND);
                // Choose url
                ...
                file_put_contents('ipn.txt', $request, FILE_APPEND);
           ...
           file_put_contents('ipn.txt', 'RESPONSE='.json_encode($response), FILE_APPEND);
