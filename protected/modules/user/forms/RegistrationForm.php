...
class RegistrationForm extends CFormModel
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('nick_name, email', 'length', 'max' => 100),
            array('password, cPassword', 'length', 'min' => $module->minPasswordLength),
            array('nick_name','match','pattern' => '/^[A-Za-z0-9]{2,50}$/','message' => Yii::t('user','Invalid format "{attribute}" only letters and numbers allowed, from 2 to 100 symbols')),
