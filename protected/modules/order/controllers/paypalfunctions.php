...
if ($SandboxFlag==false) //THIS IS REAL OPEARTING MODE!
{
	 $API_UserName="info_api1.bettime.info";
 $API_Password="D468P9LBUATHN3XU";
  // $API_Signature="6lGVLfhmxnYIKX1ekbmTdXL8kGx7d0_ZAJcP2ed6mPeLniXcR10ySS4TxqS";
 $API_Signature="AQUA4.8WjIoOBouJriv3ZhZozSE4AJhnXuPyUIpYuOi9ETkWEnMNv0b1";
}
else if ($SandboxFlag==true) //THIS IS SANDBOX MODE!
{
